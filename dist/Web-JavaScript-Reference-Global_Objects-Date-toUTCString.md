...
<small lang="zh-CN">Date.prototype.toUTCString</small>](http://www.ecma-international.org/ecma-262/5.1/#sec-15.9.5.42)</td>
...
<small lang="zh-CN">Date.prototype.toUTCString</small>](http://www.ecma-international.org/ecma-262/6.0/#sec-date.prototype.toutcstring)</td>
...
*   [`Date.prototype.toISOString()`](/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Date/toISOString "toISOString() 方法返回一个 ISO（ISO 8601 Extended Format）格式的字符串： YYYY-MM-DDTHH:mm:ss.sssZ。时区总是UTC（协调世界时），加一个后缀“Z”标识。")