...
<dl>
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/BYTES_PER_ELEMENT" title="The TypedArray.BYTES_PER_ELEMENT property represents the size in bytes of each element in an typed array."><code>Uint8ClampedArray.BYTES_PER_ELEMENT</code></a></dt>
 ...
 <dd>Static length property whose value is 3. For the actual length (number of elements), see <a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/length" title="The length accessor property represents the length (in elements) of a typed array."><code>Uint8ClampedArray.prototype.length</code></a>.</dd>
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/name" title="The TypedArray.name property represents a string value of the typed array constructor name."><code>Uint8ClampedArray.name</code></a></dt>
 ...
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/prototype" title="The TypedArray.prototype property represents the prototype for TypedArray constructors."><code>Uint8ClampedArray.prototype</code></a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/from" title="The TypedArray.from() method creates a new typed array from an array-like or iterable object. This method is nearly the same as Array.from()."><code>Uint8ClampedArray.from()</code></a></dt>
 <dd>Creates a new <code>Uint8ClampedArray</code> from an array-like or iterable object. See also <a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/from" title="The Array.from() method creates a new Array instance from an array-like or iterable object."><code>Array.from()</code></a>.</dd>
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/of" title="The TypedArray.of() method creates a new typed array with a variable number of arguments. This method is nearly the same as Array.of()."><code>Uint8ClampedArray.of()</code></a></dt>
 <dd>Creates a new <code>Uint8ClampedArray</code> with a variable number of arguments. See also <a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/of" title="The Array.of() method creates a new Array instance with a variable number of arguments, regardless of number or type of the arguments."><code>Array.of()</code></a>.</dd>
</dl>

<h2 id="Uint8ClampedArray_prototype"><code>Uint8ClampedArray</code> prototype</h2>

<p>All <code>Uint8ClampedArray</code> objects inherit from <a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/prototype" title="The TypedArray.prototype property represents the prototype for TypedArray constructors."><code>%TypedArray%.prototype</code></a>.</p>
...
<dl>
 ...
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/buffer" title="The buffer accessor property represents the ArrayBuffer referenced by a TypedArray at construction time."><code>Uint8ClampedArray.prototype.buffer</code></a> <span class="inlineIndicator readOnly readOnlyInline" title="This value may not be changed.">Read only </span></dt>
 <dd>Returns the <a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer" title="The ArrayBuffer object is used to represent a generic, fixed-length raw binary data buffer. You cannot directly manipulate the contents of an ArrayBuffer; instead, you create one of the typed array objects or a DataView object which represents the buffer in a specific format, and use that to read and write the contents of the buffer."><code>ArrayBuffer</code></a> referenced by the <code>Uint8ClampedArray</code> Fixed at construction time and thus <strong>read only</strong>.</dd>
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/byteLength" title="The byteLength accessor property represents the length (in bytes) of a typed array."><code>Uint8ClampedArray.prototype.byteLength</code></a> <span class="inlineIndicator readOnly readOnlyInline" title="This value may not be changed.">Read only </span></dt>
 <dd>Returns the length (in bytes) of the <code>Uint8ClampedArray</code> from the start of its <a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer" title="The ArrayBuffer object is used to represent a generic, fixed-length raw binary data buffer. You cannot directly manipulate the contents of an ArrayBuffer; instead, you create one of the typed array objects or a DataView object which represents the buffer in a specific format, and use that to read and write the contents of the buffer."><code>ArrayBuffer</code></a>. Fixed at construction time and thus <strong>read only.</strong></dd>
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/byteOffset" title="The byteOffset accessor property represents the offset (in bytes) of a typed array from the start of its ArrayBuffer."><code>Uint8ClampedArray.prototype.byteOffset</code></a> <span class="inlineIndicator readOnly readOnlyInline" title="This value may not be changed.">Read only </span></dt>
 <dd>Returns the offset (in bytes) of the <code>Uint8ClampedArray</code> from the start of its <a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer" title="The ArrayBuffer object is used to represent a generic, fixed-length raw binary data buffer. You cannot directly manipulate the contents of an ArrayBuffer; instead, you create one of the typed array objects or a DataView object which represents the buffer in a specific format, and use that to read and write the contents of the buffer."><code>ArrayBuffer</code></a>. Fixed at construction time and thus <strong>read only.</strong></dd>
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/length" title="The length accessor property represents the length (in elements) of a typed array."><code>Uint8ClampedArray.prototype.length</code></a> <span class="inlineIndicator readOnly readOnlyInline" title="This value may not be changed.">Read only </span></dt>
...
<dl>
 ...
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/entries" title="The entries() method returns a new Array Iterator object that contains the key/value pairs for each index in the array."><code>Uint8ClampedArray.prototype.entries()</code></a></dt>
 ...
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/find" title="The find() method returns a value in the typed array, if an element satisfies the provided testing function. Otherwise undefined is returned. TypedArray is one of the typed array types here."><code>Uint8ClampedArray.prototype.find()</code></a></dt>
 ...
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/findIndex" title="The findIndex() method returns an index in the typed array, if an element in the typed array satisfies the provided testing function. Otherwise -1 is returned."><code>Uint8ClampedArray.prototype.findIndex()</code></a></dt>
 ...
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/includes" title="The includes() method determines whether a typed array includes a certain element, returning true or false as appropriate. This method has the same algorithm as Array.prototype.includes(). TypedArray is one of the typed array types here."><code>Uint8ClampedArray.prototype.includes()</code></a> <span title="This is an experimental API that should not be used in production code."><i class="icon-beaker"> </i></span></dt>
 ...
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/join" title="The join() method joins all elements of an array into a string. This method has the same algorithm as Array.prototype.join(). TypedArray is one of the typed array types here."><code>Uint8ClampedArray.prototype.join()</code></a></dt>
 <dd>Joins all elements of an array into a string. See also <a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/join" title="The join() method joins all elements of an array (or an array-like object) into a string."><code>Array.prototype.join()</code></a>.</dd>
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/keys" title="The keys() method returns a new Array Iterator object that contains the keys for each index in the array."><code>Uint8ClampedArray.prototype.keys()</code></a></dt>
 ...
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/set" title="The set() method stores multiple values in the typed array, reading input values from a specified array."><code>Uint8ClampedArray.prototype.set()</code></a></dt>
 <dd>Stores multiple values in the typed array, reading input values from a specified array.</dd>
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/slice" title="The slice() method returns a shallow copy of a portion of a typed array into a new typed array object. This method has the same algorithm as Array.prototype.slice(). TypedArray is one of the typed array types here."><code>Uint8ClampedArray.prototype.slice()</code></a></dt>
 ...
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/subarray" title="The subarray() method returns a new TypedArray on the same ArrayBuffer store and with the same element types as for this TypedArray object. The begin offset is inclusive and the end offset is exclusive. TypedArray is one of the typed array types."><code>Uint8ClampedArray.prototype.subarray()</code></a></dt>
 <dd>Returns a new <code>Uint8ClampedArray</code> from the given start and end element index.</dd>
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/values" title="The values() method returns a new Array Iterator object that contains the values for each index in the array."><code>Uint8ClampedArray.prototype.values()</code></a></dt>
 ...
 <dt><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/@@iterator" title="The initial value of the @@iterator property is the same function object as the initial value of the values property."><code>Uint8ClampedArray.prototype[@@iterator]()</code></a></dt>
 <dd>Returns a new <code>Array Iterator</code> object that contains the values for each index in the array.</dd>
</dl>

<h2 id="Examples">Examples</h2>

<p>Different ways to create a <code>Uint8ClampedArray</code>:</p>
...
<table class="compat-table">
 <tbody>
  ...
  <tr>
   ...
   <td>11 (as of <a href="https://support.microsoft.com/en-us/kb/2929437" class="external">KB2929437</a>)</td>
   <td>11.6</td>
   <td>5.1</td>
  </tr>
  <tr>
...
<p>Starting with ECMAScript 2015,&#xA0;<code>Uint8ClampedArray</code> constructors require to be constructed with a <a href="/en-US/docs/Web/JavaScript/Reference/Operators/new" title="The new operator creates an instance of a user-defined object type or of one of the built-in object types that has a constructor function."><code>new</code></a> operator. Calling a <code>Uint8ClampedArray</code> constructor as a function without <code>new</code>, will throw a <a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypeError" title="The TypeError object represents an error when a value is not of the expected type."><code>TypeError</code></a> from now on.</p>
